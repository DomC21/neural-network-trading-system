  ...
  return (
    <Card className="w-full border-none shadow-none bg-transparent">
      <CardHeader className="text-center space-y-6">
        <CardTitle className="text-4xl sm:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-brand-gold to-brand-gold/80">
      ...
      <CardContent className="max-w-3xl mx-auto space-y-12">
        ...
        <div className="flex justify-center">
          <Button
            size="lg"
            className="group bg-brand-gold hover:bg-brand-gold/90 text-brand-black font-semibold"
